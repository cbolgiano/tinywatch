...
class BLESerial : public BLEPeripheral, public Stream
{
  ...
  private:
    ...
    BLEService _uartService = BLEService("CCC0");
    BLEDescriptor _uartNameDescriptor = BLEDescriptor("2901", "UART");
    BLECharacteristic _rxCharacteristic = BLECharacteristic("CCC2", BLEWriteWithoutResponse, BLE_ATTRIBUTE_MAX_VALUE_LENGTH);
